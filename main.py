...
for k in range(len(Dates)):
    ...
    lines.append("echo " + 'tdump_' + Month + Day + Hour + "_" + str(Height) + "_" + str(Runtime) + "                   >>CONTROL\n")
    if int(Day) < 10:
        Day = '0'+Day
    if int(Hour) <10:
        Hour = '0'+Hour
    lines.append("IF EXIST " + 'tdump_' + Month + Day + Hour + "_" + str(Height) + "_" + str(Runtime) + " DEL " + 'tdump_' + Month + Day + Hour + "_" + str(Height) + "_" + str(Runtime) + "\n")


    lines.append("%PGM%\exec\hyts_std\n")
    lines.append("   \n")
